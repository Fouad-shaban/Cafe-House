        ...
        <div class="container tm-position-relative">
            ...
            <div class="row tm-welcome-content">
                <h2 class="white-text aref-ruqaa-regular tm-welcome-header"><img src={{ asset("img/header-line.png") }} alt="Line"
                        class="tm-header-line ">&nbsp;{{ __('language.TODAYSPECIAL') }}&nbsp;&nbsp;<img src={{ asset("img/header-line.png") }}
    ...
    <div class="tm-main-section light-gray-bg">
        <div class="container" id="main">
            ...
            <section class="tm-section">
                <div class="row">
                    <div class="col-lg-12 tm-section-header-container">
                        <h2 class="tm-section-header gold-text tm-handwriting-font"><img src={{ asset("img/logo.png") }}
